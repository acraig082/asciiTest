...
namespace asciiTest
{
    class Program
    {
        ...
        static void Main()
        {
            ...
            ConsoleWriteImage(sB1);
            //sB1 = new Bitmap(@"C:\Users\xacfi_000\MyTextAdventure\story_board14i.jpg", true);
            //ConsoleWriteImage(sB1);
            //sB1 = new Bitmap(@"C:\Users\xacfi_000\MyTextAdventure\story_board14j.jpg", true);
            //ConsoleWriteImage(sB1);
            //sB1 = new Bitmap(@"C:\Users\xacfi_000\MyTextAdventure\story_board14k.jpg", true);
            //ConsoleWriteImage(sB1);
            //sB1 = new Bitmap(@"C:\Users\xacfi_000\MyTextAdventure\story_board14l.jpg", true);
            //ConsoleWriteImage(sB1);
            //sB1 = new Bitmap(@"C:\Users\xacfi_000\MyTextAdventure\story_board14m.jpg", true);
            //ConsoleWriteImage(sB1);
            ////sB1 = new Bitmap(@"C:\Users\xacfi_000\MyTextAdventure\story_board14n.jpg", true);
            ////ConsoleWriteImage(sB1);
